...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("VidyoConnector.Android.MessagingService, VidyoConnector.Android", MessagingService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MessagingService.class)
			mono.android.TypeManager.Activate ("VidyoConnector.Android.MessagingService, VidyoConnector.Android", "", this, new java.lang.Object[] {  });
	}
